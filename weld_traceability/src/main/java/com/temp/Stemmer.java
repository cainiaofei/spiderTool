...
public class Stemmer {
	...
	public static void main(String[] args) {
		...
		String strs = "interceptors decorators and observers go first public Abstract Bean Deployer E deploy Specialized the rest of the beans for Decorator Impl bean get Environment get Decorators bean initialize get Environment container Lifecycle Events fire Process Bean get Manager bean manager add Decorator bean Bootstrap Logger LOG found Decorator bean for Interceptor Impl bean get Environment get Interceptors bean initialize get Environment container Lifecycle Events fire Process Bean get Manager bean manager add Interceptor bean Bootstrap Logger LOG found Interceptor bean return this";
